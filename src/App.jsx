      ...
      <h1 className='font-bold text-center text-3xl'>iTask - Manage your todos at one place</h1>
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <div className="flex ">
            ...
            <button onClick={handleAdd} disabled={todo.length<3} className='bg-violet-800 hover:bg-violet-950 p-4 mx-3 py-2 text-sm font-bold disabled:bg-violet-700 text-white rounded-full '>Save</button>
          </div>
        </div>
